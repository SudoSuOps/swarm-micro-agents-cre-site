export default function App() {
  ...
  const graphNodes = [
    { label: "Capital", pos: "top-10 left-1/2 -translate-x-1/2" },
    { label: "Title", pos: "top-24 left-12" },
    { label: "Leases", pos: "top-24 right-12" },
    { label: "Data Room", pos: "bottom-28 left-10" },
    { label: "Portfolio", pos: "bottom-28 right-10" },
    { label: "Broker", pos: "bottom-10 left-1/2 -translate-x-1/2" },
    { label: "Underwriting", pos: "top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2" },
  ];
          ...
          <div className="grid items-center gap-14 lg:grid-cols-[1.08fr_0.92fr]">
            <div>
              ...
              <div className="mt-10 flex flex-wrap gap-4">
                ...
                <a href="#agents" className={secondaryBtn}>
              ...
              <div className="mt-12 grid gap-4 sm:grid-cols-3">
                {[
                  ...
                  <div key={title} className="rounded-3xl border border-white/8 bg-white/[0.03] p-5 backdrop-blur-sm">
              ...
              <div className="rounded-[2rem] border border-white/8 bg-gradient-to-b from-white/[0.06] to-white/[0.02] p-6 shadow-2xl shadow-black/30">
                <div className="rounded-[1.5rem] border border-white/8 bg-[#07111f]/90 p-6">
                  <div className="flex items-center justify-between">
                    ...
                    <div className="rounded-full border border-white/10 bg-white/[0.05] px-3 py-1 text-xs text-slate-100">
                      Live graph
                    </div>
                  </div>
              ...
              <div className={`${mutedCardClass} p-8`}>
                ...
                <div className="mt-8 flex flex-wrap gap-3">
                  {[
                    ...
                    <div key={item} className="rounded-full border border-white/8 bg-white/[0.04] px-4 py-2 text-sm text-slate-100">
                      {item}
                    </div>
                  ))}
                </div>
